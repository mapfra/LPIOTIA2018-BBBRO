...
@XmlType(name = GlucometerFlexContainerAnnc.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class GlucometerFlexContainerAnnc extends AbstractFlexContainerAnnc {
	
	public static final String LONG_NAME = "glucometerAnnc";
	public static final String SHORT_NAME = "glucrAnnc";
