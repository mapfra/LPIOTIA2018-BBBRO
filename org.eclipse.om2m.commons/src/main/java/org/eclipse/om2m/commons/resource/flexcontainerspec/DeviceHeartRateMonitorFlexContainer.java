...
@XmlRootElement(name = DeviceHeartRateMonitorFlexContainer.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = DeviceHeartRateMonitorFlexContainer.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class DeviceHeartRateMonitorFlexContainer extends AbstractFlexContainer {
	
	public static final String LONG_NAME = "deviceHeartRateMonitor";
	public static final String SHORT_NAME = "dHRMr";
	
	public DeviceHeartRateMonitorFlexContainer () {
