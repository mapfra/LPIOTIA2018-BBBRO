...
Device : DeviceBloodPressureMonitorAnnc
...
@XmlType(name = DeviceBloodPressureMonitorFlexContainerAnnc.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class DeviceBloodPressureMonitorFlexContainerAnnc extends AbstractFlexContainerAnnc {
	
	public static final String LONG_NAME = "deviceBloodPressureMonitorAnnc";
	public static final String SHORT_NAME = "dBPMrAnnc";
	
	public DeviceBloodPressureMonitorFlexContainerAnnc () {
