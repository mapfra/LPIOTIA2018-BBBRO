...
@XmlType(name = DeviceFanFlexContainerAnnc.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class DeviceFanFlexContainerAnnc extends AbstractFlexContainerAnnc {
	
	public static final String LONG_NAME = "deviceFanAnnc";
	public static final String SHORT_NAME = "devFnAnnc";
	
	public DeviceFanFlexContainerAnnc () {
