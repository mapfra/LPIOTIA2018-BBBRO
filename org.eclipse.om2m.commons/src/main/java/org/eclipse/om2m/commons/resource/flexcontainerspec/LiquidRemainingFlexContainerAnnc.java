...
ModuleClass : LiquidRemainingAnnc
...
@XmlType(name = LiquidRemainingFlexContainerAnnc.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class LiquidRemainingFlexContainerAnnc extends AbstractFlexContainerAnnc {
	
	public static final String LONG_NAME = "liquidRemainingAnnc";
	public static final String SHORT_NAME = "liqRgAnnc";
	
	public LiquidRemainingFlexContainerAnnc () {
