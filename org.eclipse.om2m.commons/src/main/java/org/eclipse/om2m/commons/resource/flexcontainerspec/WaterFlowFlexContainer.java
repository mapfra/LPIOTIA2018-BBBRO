...
public class WaterFlowFlexContainer extends AbstractFlexContainer {
	...
	public WaterFlowFlexContainer () {
		...
		CustomAttribute waterFlowStrength = new CustomAttribute();
		waterFlowStrength.setLongName("waterFlowStrength");
		waterFlowStrength.setShortName("waFSh");
		waterFlowStrength.setType("hd:enumWaterFlowStrength");
		getCustomAttributes().add(waterFlowStrength);
	}
