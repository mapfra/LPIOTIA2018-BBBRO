...
public class KeypadFlexContainer extends AbstractFlexContainer {
	...
	public KeypadFlexContainer () {
		...
		CustomAttribute keyNumber = new CustomAttribute();
		keyNumber.setLongName("keyNumber");
		keyNumber.setShortName("keyNr");
		keyNumber.setType("xs:integer");
		getCustomAttributes().add(keyNumber);
	}
