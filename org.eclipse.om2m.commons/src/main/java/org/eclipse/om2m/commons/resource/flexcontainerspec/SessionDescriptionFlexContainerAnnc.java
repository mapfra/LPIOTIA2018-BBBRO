...
ModuleClass : SessionDescriptionAnnc
...
@XmlType(name = SessionDescriptionFlexContainerAnnc.SHORT_NAME, namespace = "http://www.onem2m.org/xml/protocols/homedomain")
public class SessionDescriptionFlexContainerAnnc extends AbstractFlexContainerAnnc {
	
	public static final String LONG_NAME = "sessionDescriptionAnnc";
	public static final String SHORT_NAME = "sesDnAnnc";
	
	public SessionDescriptionFlexContainerAnnc () {
