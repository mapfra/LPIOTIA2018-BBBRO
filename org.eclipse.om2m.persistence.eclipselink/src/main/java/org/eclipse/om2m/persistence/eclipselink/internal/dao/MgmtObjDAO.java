...
public class MgmtObjDAO extends AbstractDAO<MgmtObjEntity> {
	...
	private AreaNwkInfoDAO areaNwkInfoDAO;
	private AreaNwkDeviceInfoDAO areaNwkDeviceInfoDAO;
	
	public MgmtObjDAO() {
		deviceInfoDAO = new DeviceInfoDAO();
		areaNwkDeviceInfoDAO = new AreaNwkDeviceInfoDAO();
		areaNwkInfoDAO = new AreaNwkInfoDAO();
	}
